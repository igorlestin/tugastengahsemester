package com.example.android.todo_list.jadwalin;
...
import com.example.android.todo_list.jadwalin.Adapters.NoteAdapter;
import com.example.android.todo_list.jadwalin.Entity.Note;
import com.example.android.todo_list.jadwalin.ViewModel.NoteViewModel;
import com.example.android.todo_list.jadwalin.Helper.Helper;
...
public class NoteActivity extends AppCompatActivity implements View.OnClickListener, NoteAdapter.onItemClickListner {
    ...
    protected void attachBaseContext(Context newbase) {
        super.attachBaseContext(Helper.onAttach(newbase, "en"));
    }

    private void updateView (String lang) {
        Context context = Helper.setLocale(this, lang);
        Resources resource = context.getResources();

        textView.setText(resource.getString(R.string.app_name));
    }
